...
export const knowledgeBase = {
  ...
  abonnements: {
    decouverte: {
      ...
      avantages: [
        ...
        'Recherche basique',
        'Acces aux 98 sources officielles',
  ...
  sources: {
    description: 'AB DRIDI agrege 98 sources officielles dont le BOAMP (Bulletin Officiel des Annonces de Marches Publics), les plateformes de dematerialisation regionales, et le TED (marches europeens).',
...
const categories: Category[] = [
  ...
  },
  {
    ...
    responses: [
      () => `${knowledgeBase.pages.consultations}\n\nLes resultats proviennent de **98 sources officielles** (BOAMP, TED, DECP, e-marchespublics). Pour des recherches illimitees, passez au plan Veille & Accompagnement.`,
      ...
      () => `La recherche de marches est simple : utilisez la page **Consultations** pour filtrer par mot-cle, nature (travaux, services, fournitures), departement et montant. Les donnees proviennent de 98 sources officielles francaises et europeennes.`,
    ],
  },
  {
    name: 'CONCURRENCE',
